...
const products = [
  ...
  },
  {
    name:"صابون طبيعي",
    price:"EGP 90",
    img:"image/500d7ee4-fe2c-4379-b673-bcb928e7a656-removebg-preview.png",
    desc:"مجموعة متنوعة من الصابون الطبيعي المصنوع بعناية لترطيب البشرة وتنظيفها بلطف، غني بخلاصات طبيعية تمنحك نعومة وانتعاش يدوم طويلًاكل لون يعكس رائحة مميزة وخواص مختلفة تناسب جميع أنواع البشرة، لتجربة عناية فاخرة يومية.",
  }
];
